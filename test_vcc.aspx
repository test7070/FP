<%@ Page Language="C#" Debug="true"%>
    <script language="c#" runat="server">         	//出貨單列印(套表)_榮泉
        public class ParaIn{
        ...
        public void Page_Load(){
        	...
        	connectionString = "Data Source=127.0.0.1,1799;Persist Security Info=True;User ID=sa;Password=artsql963;Database="+db;  //資料庫連結
			var item = new ParaIn();
            ...
            using (System.Data.SqlClient.SqlConnection connSource = new System.Data.SqlClient.SqlConnection(connectionString)){
                ...
                string queryString = @" 
                                        ...
                                        set @t_showprice = case when @t_showprice then char(10) else @t_showprice end
										...
										if(@t_showprice = 0)
										begin
											update @tmp set price=null, total=null, total3=null, total4=null
										end
										";
